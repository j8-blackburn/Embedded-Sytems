...
//Function to show how many overrides have occured
void overridecounter(int overrides){
...
//Function that flashes LED3 when this function is activated
void incorrectmode(){
    led1 = 0;
    led3 = 0;
    for(int i = 0; i < 1; i++){
